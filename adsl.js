...
interface adsl {slot}
deactivate {portNum}
activate {portNum} lineProfileindex 1
...
oam loopback {portNum} {vpi} {vci} end-loopback 3`, description: "PVC test via OAM loopback" },
  ...
  zte_c300: {
    ...
    diagnostics: {
      "Состояние порта": [
        { command: `show interface vdsl_{slot}/{portNum}`, description: "Информация об интерфейсе" },
...
vdsl2 snrmargin-prf SNR12`, description: "Смена профиля SNR" },
  ...
  zte_9xxx: {
    ...
    diagnostics: {
      "Состояние порта": [
        { command: `show interface {slot}/{portNum}`, description: "Информация об интерфейсе" },
      ...
      "Смена профиля": [
        ...
        { command: `adsl line-profile DEF8M.PRF`, description: "Установка профиля" },
      ],
      "Работа с VLAN": [
  ...
  alsitek: {
    ...
    diagnostics: {
      "Физика порта": [
        { command: `show interface dsl {port}`, description: "Информация о порте DSL" },
  ...
  iskratel: {
    ...
    diagnostics: {
      "Состояние порта": [
        { command: `show interface dsl{portNum}:{vpi}_{vci}`, description: "Информация об интерфейсе" },
        { command: `show dsl port {portNum}`, description: "Информация о DSL порте" },
      ...
      "Работа с профилями": [
        ...
        { command: `set dsl port {portNum} profile 5`, description: "Установка профиля" },
      ],
      "Работа с VLAN": [
      ...
      "Дополнительные команды": [
        ...
        { command: `show board`, description: "Информация о платах" },
        { command: `show pppoe`, description: "Информация о PPPoE" },
        { command: `show dhcpr`, description: "Информация о DHCP relay" },
        { command: `show system info`, description: "Информация о системе" },
  ...
  zyxel_5000: {
    ...
    diagnostics: {
      ...
      "Работа с профилями": [
        ...
        { command: `port show {slot}-{portNum}`, description: "Информация о порте" },
      ],
      "Смена профиля": [
        { command: `port adsl set {slot}-{portNum} base-6 auto`, description: "Установка профиля" },
      ],
      "Работа с VLAN": [
      ...
      "Работа с алармами": [
        { command: `alarm history show`, description: "История алармов" },
      ],
    },
  },
  ...
  genew_photel_px90: {
    ...
    diagnostics: {
      ...
      "Профили": [
        ...
        { command: `profile show ch-adsl Имя_профиля`, description: "Просмотр канального профиля" },
        { command: `profile show sp-adsl Имя_профиля`, description: "Просмотр спектрального профиля" },
      ],
      "Multicast": [
      ...
      "Диагностика DSLAM": [
        ...
        { command: `slot 1-{slot} ASL port show interface atm {portNum}:{vpi}.{vci}`, description: "Инкапсуляция на порту" },
        { command: `slot 1-{slot} ASL port show interface`, description: "Инкапсуляция на всех портах платы" },
